...
func showHelp() {
	...
	fmt.Println("  2 - Calories    Track food, calorie budget, intermittent fasting")
	fmt.Println("  3 - Gym         Log workouts, duration, calories burnt")
	fmt.Println("  4 - Mood        Rate your day (1-5) with notes")
	fmt.Println("  5 - Monthly     Monthly aggregates and day-by-day heatmap")
	fmt.Println()
	fmt.Println("Controls:")
	fmt.Println("  1-5, Tab         Switch tabs")
